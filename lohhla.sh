#!/bin/bash
export R_LIBS=/mnt/cfs/med18b/med/renqian/env/lib/R:$R_LIBS
...
export LD_LIBRARY_PATH="/mnt/cfs/med18b/med/renqian/env/lib:/mnt/nfs/software/lib:/mnt/cfs/med18b/med/renqian/env/lib:/mnt/nfs/software/lib:/mnt/cfs/med18b/med/renqian/env/lib:/mnt/nfs/software/lib::/opt/MonitorSoftware/lib:/usr/sfw/lib:/usr/local/lib:$LD_LIBRARY_PATH"
...
hlas=$5
solution=$6
Rscript /mnt/cfs/med18b/med/renqian/software/lohhla/LOHHLAscript.R \
        --patientId $sample \
        --outputDir $outtput \
        --normalBAMfile $normal \
        --BAMDir $bam \
        --hlaPath $hlas \
        --HLAfastaLoc /mnt/cfs/med18b/med/renqian/software/lohhla/data/hla_all.fasta \
        --CopyNumLoc $solution \
        --mappingStep TRUE --minCoverageFilter 10 --fishingStep TRUE --cleanUp FALSE \
        --HLAexonLoc /mnt/cfs/med18b/med/renqian/software/lohhla/data/hla.dat \
        --gatkDir /mnt/cfs/med18b/med/renqian/software/picard-tools-1.119 \
        --novoDir /mnt/cfs/med18b/med/renqian/software/novocraft/
